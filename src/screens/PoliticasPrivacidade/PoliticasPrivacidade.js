        ...
        return (
            <View style={StylePoliticas.container}>
                <View style={StylePoliticas.header}>
                    ...
                    <Text style={StylePoliticas.title}>Termos de Uso</Text>
                </View>
                <ScrollView style={StylePoliticas.scrollPoliticas}>
                    <Text style={[StylePoliticas.politicas, { textAlign: "center", fontWeight: "bold" }]}>TERMOS DE SERVIÇO</Text>
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5 }]}>VISÃO GERAL</Text>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5 }]}>SEÇÃO 1 - TERMOS DE USO </Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 2 - CONDIÇÕES GERAIS</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 4 - LINKS DE TERCEIROS</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 5 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 6 - INFORMAÇÕES PESSOAIS</Text>
                    <Text style={StylePoliticas.politicas}>
                        O envio de suas informações pessoais através da plataforma é regido pela nossa Política de privacidade. Ver nossa
                        Política de privacidade.
                    </Text>
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 7 – ERROS E IMPRECISÕES</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 8 - USOS PROIBIDOS</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 9 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 10 – INDENIZAÇÃO</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 11 – INDEPENDÊNCIA</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 12 - ACORDO INTEGRAL</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 13 - LEGISLAÇÃO APLICÁVEL</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 14 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</Text>
                    <Text style={StylePoliticas.politicas}>
                    ...
                    <Text style={[StylePoliticas.politicas, { fontWeight: "bold", marginBottom: 5, marginTop: 5 }]}>SEÇÃO 15 – DADOS</Text>
                    <Text style={StylePoliticas.politicas}>
